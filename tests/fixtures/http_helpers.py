...
class HttpMockHelpers:
    ...
    @staticmethod
    def create_structure_response(title="Test Structure", method="X-RAY DIFFRACTION", resolution=2.5):
    ...
    def create_entry_response(entity_ids):
        ...
        return {
            "rcsb_entry_container_identifiers": {
                "non_polymer_entity_ids": entity_ids
            }
        }
    ...
    @staticmethod
    def setup_httpx_mock(mock_client_cls, response_data, status_code=200, side_effect=None):
...
def common_http_errors():
    ...
    return {
        "not_found": httpx.HTTPStatusError("Not found", request=None, response=AsyncMock(status_code=404)),
