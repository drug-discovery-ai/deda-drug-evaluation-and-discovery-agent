...
class TestBioinformaticsToolBase:
    ...
    @pytest.mark.unit
    def test_tool_base_initialization_with_clients(self, mock_uniprot_client, mock_pdb_client, mock_sequence_analyzer):
...
@pytest.mark.unit
@pytest.mark.parametrize("tool_class,expected_name,expected_desc_contains", [
...
class TestGetProteinFastaTool:
    ...
    @pytest.mark.unit
    async def test_async_run(self, fasta_tool, mock_uniprot_client, spike_protein_uniprot_id):
        ...
        mock_uniprot_client.get_fasta_sequence.assert_called_once_with(spike_protein_uniprot_id)
...
class TestGetProteinDetailsTool:
    ...
    @pytest.mark.unit
    async def test_async_run(self, details_tool, mock_uniprot_client, spike_protein_uniprot_id):
        """Test asynchronous execution."""
        expected_details = {
        ...
        mock_uniprot_client.get_details.assert_called_once_with(spike_protein_uniprot_id)
...
class TestAnalyzeSequencePropertiesTool:
    ...
    @pytest.mark.unit
    async def test_async_run(self, analyze_tool, mock_sequence_analyzer, spike_protein_uniprot_id):
        """Test asynchronous execution."""
        expected_analysis = {
            "length": 1273,
        ...
        mock_sequence_analyzer.analyze_from_uniprot.assert_called_once_with(spike_protein_uniprot_id)
...
class TestCompareProteinVariantTool:
    ...
    @pytest.mark.unit
    async def test_async_run(self, variant_tool, mock_sequence_analyzer, spike_protein_uniprot_id):
        """Test asynchronous execution."""
        expected_comparison = {
            "mutation": "D614G",
        ...
        mock_sequence_analyzer.compare_variant.assert_called_once_with(spike_protein_uniprot_id, "D614G")
...
class TestGetTopPDBIdsTool:
    ...
    @pytest.mark.unit
    async def test_async_run(self, pdb_ids_tool, mock_uniprot_client, spike_protein_uniprot_id):
        """Test asynchronous execution."""
        ...
        mock_uniprot_client.get_pdb_ids.assert_called_once_with(spike_protein_uniprot_id)
...
class TestGetStructureDetailsTool:
    ...
    @pytest.mark.unit
    async def test_async_run(self, structure_tool, mock_pdb_client, spike_protein_pdb_id):
        """Test asynchronous execution."""
        expected_details = {
        ...
        assert result == expected_details
        mock_pdb_client.get_structure_details.assert_called_once_with(spike_protein_pdb_id)
...
class TestGetLigandSmilesTool:
    ...
    @pytest.mark.unit
    async def test_async_run(self, ligands_tool, mock_pdb_client, spike_protein_uniprot_id):
        """Test asynchronous execution."""
        expected_ligands = [
        ...
        mock_pdb_client.get_ligands_for_uniprot.assert_called_once_with(spike_protein_uniprot_id)
...
class TestCreateBioinformaticsTools:
    ...
    def test_tools_have_correct_args_schema(self):
        ...
        from drug_discovery_agent.interfaces.langchain.models import (
            UniProtCodeInput, PDBIdInput, RawSequenceInput, ProteinVariantInput
        )
    ...
    def test_all_tools_exported(self):
        ...
        from drug_discovery_agent.interfaces.langchain.tools import __all__ as exported_names
        ...
        for export_name in expected_exports:
            assert export_name in exported_names, f"{export_name} not in __all__ exports"