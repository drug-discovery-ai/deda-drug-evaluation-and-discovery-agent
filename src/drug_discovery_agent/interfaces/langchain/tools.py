...
class BioinformaticsToolBase(BaseTool):
    ...
    def __init__(self, 
        ...
        self._sequence_analyzer = sequence_analyzer or SequenceAnalyzer(self._uniprot_client)
...
class GetTopPDBIdsTool(BioinformaticsToolBase):
    ...
    description: str = "Fetch top 10 representative PDB entries from UniProt cross-references"
    args_schema: Type[BaseModel] = UniProtCodeInput
...
def create_bioinformatics_tools(uniprot_client: Optional[UniProtClient] = None,
                               pdb_client: Optional[PDBClient] = None,
                               sequence_analyzer: Optional[SequenceAnalyzer] = None) -> List[BioinformaticsToolBase]:
    ...
    return [
        GetProteinFastaTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
        GetProteinDetailsTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
        AnalyzeSequencePropertiesTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
        AnalyzeRawSequenceTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
        CompareProteinVariantTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
        GetTopPDBIdsTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
        GetStructureDetailsTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
        GetLigandSmilesTool(uniprot_client=uniprot_client, pdb_client=pdb_client, sequence_analyzer=sequence_analyzer),
    ]
