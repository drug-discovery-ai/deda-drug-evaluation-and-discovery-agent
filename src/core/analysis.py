...
from .uniprot import fetch_protein_fasta_sequence


async def analyze_sequence_properties(uniprot_code: str) -> Dict[str, Any]:
    ...
    """
    data = await fetch_protein_fasta_sequence(uniprot_code)
...
def analyze_raw_sequence_properties(sequence: str) -> Dict[str, Any]:
...
async def compare_protein_variant(uniprot_id: str, mutation: str) -> Dict[str, Any]:
    ...
    """
    try:
        fasta = await fetch_protein_fasta_sequence(uniprot_id)
        ...
        wild_props = analyze_raw_sequence_properties(wild_seq)
        variant_props = analyze_raw_sequence_properties(mutated_seq)
