"""UniProt-related bioinformatics functions."""
from typing import Any, Dict
import httpx
from ..utils.constants import VIRUS_UNIPROT_REST_API_BASE
from ..utils.http_client import make_fasta_request, make_api_request


async def fetch_protein_fasta_sequence(uniprot_code: str) -> str:
...
async def fetch_protein_details(uniprot_code: str) -> Dict[str, Any]:
...
async def fetch_top_pdb_ids_for_uniprot(uniprot_id: str) -> list[str]:
